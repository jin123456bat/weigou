var Dashboard = function() {
    ...
    return {
        ...
        initAmChart1: function(start,end) {
			...
			$.ajax({
				url:'./index.php?m=ajax&c=source&a=dashboard&type=order',
				async:false,
				method:'post',
...
//                }
		...
		initAmChart2: function(start,end) {
			...
			$.ajax({
				url:'./index.php?m=ajax&c=source&a=dashboard&type=payed',
				async:false,
				method:'post',
				data:{start:start,end:end},
				success: function(response){
...
//                }
        ...
        initAmChart3: function(start,end) {
			...
			var chartData = [];
			$.ajax({
				url:'./index.php?m=ajax&c=source&a=dashboard&type=user',
				async:false,
				method:'post',
				data:{start:start,end:end},
				success: function(response){

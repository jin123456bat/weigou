...
$('#receiving_search').on('submit',function(){
	receiving.addAjaxParameter('status',$(this).find('select').val());
	receiving.search($(this).find('input').val());
	return false;
});

//批量操作
$('#receiving .multipleBtn').on('click',function(){

        ...
        grid.init({
            ...
            dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options 
				...
				columnDefs:[{
					...
					targets:5,
					render:function(data,type,full){
						return '<font style="cursor:pointer;" class="popovers" data-container="body" data-html="true" data-trigger="click hover" data-placement="right" data-content="省份:'+full.province+'<br>城市:'+full.city+'<br>地区:'+full.county+'<br>地址:'+full.address+'<br>邮编:'+full.zcode+'<br>姓名:'+full.address_name+'<br>电话:'+full.address_telephone+'" data-original-title="收货地址">'+(data==1?'已发货':'未发货')+'</font>';
					}
				},{
					targets:6,
					render:function(data,type,full){
                ...
                "ajax": {
                    "url": "index.php?c=datatables&a=source_order2", // ajax source
                },
                "order": [
                    [2, "desc"]
                ],

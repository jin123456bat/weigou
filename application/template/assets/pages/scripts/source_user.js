        ...
        grid.init({
            ...
            dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options 
				...
				columns:[{
					...
					data:'swift_money',
					name:'IFNULL((select sum(a.money)-(select sum(b.money) from swift as b where b.uid=user.id and b.type=1 and b.source = 8) from swift as a where a.uid=user.id and a.type=0 and a.source in (2,3,4,5,6,7)),"0.00")',
					orderable:true
				},{
					data:'description',
                ...
                "ajax": {
                    "url": "index.php?c=datatables&a=source_user&", // ajax source
                },
                "order": [
                    [3, "asc"]
